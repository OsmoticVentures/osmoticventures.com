/**
 * Metri Bio client pages: /metribio/sow, /metribio/strategy, and /metribio/why (any letter case).
 *
...
export async function POST(req: Request, { params }: { params: Promise<{ doc: string }> }) {
  ...
  return new Response(null, {
    ...
    headers: {
      Location: path,
      "Set-Cookie": `${COOKIE}=${TOKEN}; Path=/metribio; Max-Age=${MAX_AGE}; HttpOnly; Secure; SameSite=Lax`,
